export function createWelcomeEmailTemplate(name, clientURL) {
  ...
  <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f5f5f5;">
    <div style="background: linear-gradient(to right, #36D1DC, #5B86E5); padding: 30px; text-align: center; border-radius: 12px 12px 0 0;">
      <img src="https://www.bing.com/images/search?view=detailV2&ccid=PYM1jmhX&id=E17CB119FD9C22E1451D294CFA1213BFA710BF91&thid=OIP.PYM1jmhXygU0x_g6tKMe7QHaHa&mediaurl=https%3a%2f%2fplay-lh.googleusercontent.com%2fbT2xm67uTBd9kIg375U1YtUDs4zeyh0g6mOnXKsNy0zYWprxsuboXddWf4u6WcCZYJ-W&exph=512&expw=512&q=hrms+chat+logo+&FORM=IRPRST&ck=25849D9EB4902CDEAF9971E96731F417&selectedIndex=2&itb=0" alt="Messenger Logo" style="width: 80px; height: 80px; margin-bottom: 20px; border-radius: 50%; background-color: white; padding: 10px;">
